...
radius1      = radius * proportion1 / (proportion1 + proportion2)
radius2      = radius * proportion2 / (proportion1 + proportion2)
weight       = 1
eccentricity = 1
...
arg = [nbfmm, output, width, height, fps, num_second, \
       ...
       model, proportion1, proportion2, radius1, radius2, weight, eccentricity]
